export type DebugScope = "spotify" | "lastfm" | "musicbrainz" | "wikidata" | "firecrawl" | "web-search" | "artist-verification" | "artist-consolidation" | "similar-artists" | "seeds" | "profile" | "youtube" | "deezer" | "events" | "pipeline" | "booking" | "genre" | "sources" | "enrichment" | "concert-history" | "ticketmaster" | "openai-concerts" | "labels" | "bookers" | "industry" | "chartmetric" | "concerts50";
...
const DEBUG_FLAG_BY_SCOPE: Record<DebugScope, string> = {
  ...
  labels: "DEBUG_LABELS",
  bookers: "DEBUG_BOOKERS",
  industry: "DEBUG_INDUSTRY",
  chartmetric: "DEBUG_CHARTMETRIC",
  concerts50: "DEBUG_CONCERTS50"
};

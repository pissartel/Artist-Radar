  ...
  return (
    <div className="lg:absolute lg:inset-0 lg:flex lg:flex-col">
      ...
      <div
        ...
        tabIndex={0}
        className="h-[min(70vh,640px)] min-h-80 overflow-y-auto overscroll-contain pr-1 focus-visible:outline-none focus-visible:shadow-focus [scrollbar-gutter:stable] lg:h-auto lg:min-h-0 lg:flex-1"
      >
        {activeTab === "Raw JSON" ? (

...
export interface OnboardingFormProps {
  // Server-derived (issue #142 follow-up): whether the "Use Chartmetric
...
export default function OnboardingForm({ showChartmetricToggle, showPreviewDataToggle }: OnboardingFormProps) {
  ...
  const [formData, setFormData] = useState<OnboardingFormData>({
    ...
    // to show the checkbox in the first place.
    chartmetricToggleVisible: showChartmetricToggle,
  });

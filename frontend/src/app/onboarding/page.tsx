...
import { isChartmetricToggleVisible, isPreviewDataToggleVisible } from "@/lib/server/chartmetricToggle";
...
export default function OnboardingPage() {
  return <OnboardingForm
    showChartmetricToggle={isChartmetricToggleVisible()}
    showPreviewDataToggle={isPreviewDataToggleVisible()}
  />;
}
